...
const FirstColumnCell = ({title, unit, style, icon}) => (
  <View style={[{flex: 1, flexDirection: 'row', borderBottomWidth: 1}, style]}>
...
const Cell = ({title, from, to, style, target, control}) => (
  <View style={[styles.cell, style, {borderBottomWidth: 1}]}>
...
const Empty = ({children, style}) => (
  <View style={[styles.emptyCell, styles.borderBottom, style]}>{children}</View>
);

const BodyCompositionTable2 = data => {
...
export default BodyCompositionTable2;
